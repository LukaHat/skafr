...
| `--no-ci`              | ci on        | Skip GitHub Actions CI workflow generation                |
...
> **CI:** A `.github/workflows/ci.yml` is generated by default. It runs on push and pull request to `main`, installs deps, builds, and runs tests using Node.js 22. Skip with `--no-ci`.
