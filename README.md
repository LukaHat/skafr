...
> **CI:** A `.github/workflows/ci.yml` is generated by default. It runs on all pushes and pull requests, installs deps, builds, and runs tests using Node.js 22. Skip with `--no-ci`.
